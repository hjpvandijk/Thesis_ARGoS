        ...
        for end_time in end_times:
            for spawn_time in spawn_times:
                for noise in noises:
                    ...
                    if os.path.exists(datafile_certainty) and os.path.exists(datafile_coverage) and os.path.exists(datafile_nodes) and os.path.exists(datafile_max_nodes) and os.path.exists(datafile_traveled_path) and os.path.exists(datafile_battery_usage) and os.path.exists(datafile_mission_time) and os.path.exists(datafile_distance_to_deployment_site) and os.path.exists(datafile_collisions):
                        continue
                            ...
                            for max_frontier_region in max_frontier_regions:
                                for max_route_length in max_route_lengths:
                                    ...
                                    for agent in agents:
                                        ...
                                        data_for_map_spawn_time_noise_certainty[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}_all'] = mean_certainty_seeds_all[:exp_duration_index]
                                        data_for_map_spawn_time_noise_certainty[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}_free'] = mean_certainty_seeds_free[:exp_duration_index]
                                        data_for_map_spawn_time_noise_certainty[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}_occupied'] = mean_certainty_seeds_occupied[:exp_duration_index]
                                        ...
                                        data_for_map_spawn_time_noise_coverage[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}'] = mean_coverage_seeds[:exp_duration_index]
                                        ...
                                        data_for_map_spawn_time_noise_nodes[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}_nodes'] = mean_nodes_seeds[:exp_duration_index]
                                        data_for_map_spawn_time_noise_nodes[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}_leaves'] = mean_leaves_seeds[:exp_duration_index]
                                        ...
                                        data_for_map_spawn_time_noise_max_nodes[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}_max_nodes'] = mean_max_nodes_seeds
                                        data_for_map_spawn_time_noise_max_nodes[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}_max_leaves'] = mean_max_leaves_seeds
                                        ...
                                        data_for_map_spawn_time_noise_traveled_path[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}'] = mean_nodes_seeds
                                        ...
                                        data_for_map_spawn_time_noise_battery_usage[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}'] = mean_nodes_seeds
                                        
                                        #MISSION TIME
                                        average_mission_time_df = pd.DataFrame(average_mission_time)
                                        mean_nodes_seeds = average_mission_time_df.mean(axis=0).to_numpy()
                                        data_for_map_spawn_time_noise_mission_time[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}'] = mean_nodes_seeds
                                        #DISTANCE TO DEPLOYMENT SITE
                                        ...
                                        data_for_map_spawn_time_noise_distance_to_deployment_site[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}'] = mean_nodes_seeds
                                        #COLLISIONS
                                        ...
                                        data_for_map_spawn_time_noise_collisions[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}_obstacle'] = mean_nodes_seeds
                                        ...
                                        data_for_map_spawn_time_noise_collisions[f'fsr_{frontier_search_radius}_mfr_{max_frontier_region}_mrl_{max_route_length}_{agent}_agent'] = mean_nodes_seeds
                    #create dataframes
