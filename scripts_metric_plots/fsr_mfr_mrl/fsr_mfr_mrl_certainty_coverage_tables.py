...
def plot_certainty_with_different_configs(usb_drive, categories_and_values):
    ...
    for file in os.listdir(dir):
        ...
        if not os.path.exists('coverage_plots/fsr_mfr_mrl/csv_tables'):
            os.makedirs('coverage_plots/fsr_mfr_mrl/csv_tables')
        ...
        #export to csv
        end_certainty_stats_per_n_agents_df.to_csv(f'coverage_plots/fsr_mfr_mrl/csv_tables/AC(T_end)_{map}_noise_{noise}_spawn_time_{spawn_time}.csv', index=False)
        ...
        #export to csv
        AAC_stats_per_n_agents_df.to_csv(f'coverage_plots/fsr_mfr_mrl/csv_tables/AAC_{map}_noise_{noise}_spawn_time_{spawn_time}.csv', index=False)
...
def plot_coverage_with_different_configs(usb_drive, categories_and_values):
    ...
    for file in os.listdir(dir):
        ...
        #if not exists
        if not os.path.exists(f'coverage_plots/fsr_mfr_mrl/csv_tables'):
            os.makedirs(f'coverage_plots/fsr_mfr_mrl/csv_tables')
        ...
        #export to csv
        end_coverages_per_n_agents_df.to_csv(f'coverage_plots/fsr_mfr_mrl/csv_tables/CP(T_end)_{env_map}_noise_{noise}_spawn_time_{spawn_time}.csv', index=False)
        ...
        #export to csv
        ACP_stats_per_n_agents_df.to_csv(f'coverage_plots/fsr_mfr_mrl/csv_tables/ACP_{env_map}_noise_{noise}_spawn_time_{spawn_time}.csv', index=False)
            #set legend
