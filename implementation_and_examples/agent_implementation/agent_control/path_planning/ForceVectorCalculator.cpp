...
//        if (sqrt(pow(frontierRegionX - agent->position.x, 2) + pow(frontierRegionY - agent->position.y, 2)) < agent->FRONTIER_DIST_UNTIL_REACHED) {
            //If the frontier is close to the agent, skip this frontier
            continue;
//        }
