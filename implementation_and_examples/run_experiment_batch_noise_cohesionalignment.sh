...
# EXPERIMENTS=("office.argos" "office_tilted.argos")
...
CONFIGS=(
"BASE_AAVFIXcohesionalignment_end_time_{END_TIME}_noise_0_wifi_range_99999_message_loss_probability_0_frontier_search_radius_99999_evaporation_time_100.yaml"
"BASE_AAVFIXcohesionalignment_end_time_{END_TIME}_noise_0_5_wifi_range_99999_message_loss_probability_0_frontier_search_radius_99999_evaporation_time_100.yaml"
"BASE_AAVFIXcohesionalignment_end_time_{END_TIME}_noise_1_wifi_range_99999_message_loss_probability_0_frontier_search_radius_99999_evaporation_time_100.yaml"
"BASE_AAVFIXcohesionalignment_end_time_{END_TIME}_noise_1_5_wifi_range_99999_message_loss_probability_0_frontier_search_radius_99999_evaporation_time_100.yaml"
)
...
#                  #if "mission_time.csv" exists, skip this experiment
                  if [ -f "$METRIC_PATH/mission_time.csv" ]; then
...
#clear failed_experiments.txt
#remove the file if it exists
if [ -f "failed_experiments.txt" ]; then
  rm "failed_experiments.txt"
fi
