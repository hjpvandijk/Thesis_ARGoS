                        ...
                        for evaporation_time in options["quadtree.evaporation_time"]:
                            for max_frontier_cells in options["forces.max_frontier_cells"]:
                                for max_route_length in options["control.path_planning.max_route_length"]:
                                    ...
                                    yaml_path = os.path.join(dir, f"end_time_{end_time}_noise_{noise}_wifi_range_{wifi_range}_message_loss_probability_{message_loss_probability}_frontier_search_radius_{frontier_search_radius}_evaporation_time_{evaporation_time}_max_frontier_cells_{max_frontier_cells}_max_route_length_{max_route_length}.yaml")
                                    ...
                                    if outer == 0:
                                        print(f"\"end_time_{{END_TIME}}_noise_{noise}_wifi_range_{wifi_range}_message_loss_probability_{message_loss_probability}_frontier_search_radius_{frontier_search_radius}_evaporation_time_{evaporation_time}_max_frontier_cells_{max_frontier_cells}_max_route_length_{max_route_length}.yaml\" ")
        outer += 1
